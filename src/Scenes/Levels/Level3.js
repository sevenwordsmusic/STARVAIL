...
export default class Level3 extends Phaser.Scene {
  ...
  constructor() {
    super('levelThird' + (Level3.getNumber() + 1));
    Level3.addNumber();
  }
  preload(){
  ...
  create() {
    ...
    //Backgrounds.
    this.add.image(-2000, 500, 'bg3').setScale(2).setScrollFactor(0.5,0.1).setDepth(-300);
  ...
  pauseGame(){
    ...
    this.scene.pause('levelThird' + (Level3.getNumber()));
  }
