...
*/
  ...
  initializeWeaponsArray(){
    ...
    this.weapons[4] = {name: "BombNormal", damage: 20, area: 45, knockback:  2 / this.scene.matter.world.getDelta(), fireRate: 25 * this.scene.matter.world.getDelta(), projectileSpeed: 10, expireTime: 2000, energyCost: 30, energyRecoverProportion: 0.2, wSprite: 7, chFrame: 1};
    ...
    this.weapons[6] = {name: "Misil", damage: 40, area: 30, knockback: 1 / this.scene.matter.world.getDelta(), autoAim: 0.08 / this.scene.matter.world.getDelta(), fireRate: 20 * this.scene.matter.world.getDelta(), projectileSpeed: 15, expireTime: 4000, energyCost: 50, energyRecoverProportion: 0.2, wSprite: 2, chFrame: 2};
    this.weapons[7] = {name: "MissileMulti", damage: 5, area: 25, knockback: 1 / this.scene.matter.world.getDelta(), offsprings: 7, offspringScale: 0.9, fireRate: 30 * this.scene.matter.world.getDelta(), projectileSpeed: 12, expireTime: 4000, energyCost: 90, energyRecoverProportion: 0.2, wSprite: 5, chFrame: 2};
    this.weapons[8] = {name: "Lasser", damage: 1.5, spread: 0, fireRate: 0, projectileSpeed: 0, expireTime: 0, energyCost: 1, energyRecoverProportion: 0, wSprite: "", chFrame: 3};
  }
