...
export default class Player {
  ...
  initializeWeaponsArray(){
    ...
    this.weapons[8] = {name: "Lasser", damage: 0.82, spread: 0, fireRate: 0, projectileSpeed: 0, expireTime: 0, energyCost: 0.004, energyRecoverProportion: 0, wSprite: "", chFrame: 0};
  }
